...
def validate_and_save_model(args, val_dataloader, model, best_score, epoch, validate_fn, logger, model_save_path, fold):
    loss, results = validate_fn(model, val_dataloader, args, fold, epoch)
...
def setup_cp_files(args):
    ...
    dst_file_list = ['config', 'data_helper', 'main-k','inference-k', 'main','model_gdy', 'model', 'util', 'category_id_map', 'evaluate', 'model_uni','inference-k-newswa', 'main-k-Copy']
